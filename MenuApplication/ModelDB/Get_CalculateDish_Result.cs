...
namespace MenuApplication.ModelDB
{
    ...
    public partial class Get_CalculateDish_Result
    {
        ...
        public Nullable<double> Cost100Portion { get; set; }
        public Nullable<double> Cost1Portion { get; set; }
        public Nullable<double> ProteinValueOn1Dish { get; set; }
        public Nullable<double> FatValueOn1Dish { get; set; }
        public Nullable<double> CarbohydrateValueOn1Dish { get; set; }
        public Nullable<double> CalorificValueOn1Dish { get; set; }
    }
}
